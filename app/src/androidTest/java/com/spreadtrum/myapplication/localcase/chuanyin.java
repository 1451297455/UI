...
/**
 * Created by Jinchao_1.Zhang on 2017/11/2.
 */
@RunWith(AndroidJUnit4.class)
public class chuanyin {

    //定义启动/停止应用的命令
    private static final String dialer = "am start -n com.android.contacts/.activities.DialtactsActivity";
    private static final String stop_dialer = "am force-stop com.android.contacts";

    private static final String sms = "am start -n com.android.mms/.ui.ConversationList";
    private static final String stop_sms = "am force-stop com.android.mms";

    private static final String contacts = "am start -n com.android.contacts/.activities.PeopleActivity";
    private static final String stop_contacts = "am force-stop com.android.contacts";

    private static final String browser = "am start -n com.android.browser/com.UCMobile.main.UCMobile";
    private static final String stop_browser = "am force-stop com.android.browser";

    private static final String music = "am start -n com.android.mediacenter/.PageActivity ";
    private static final String stop_music = "am force-stop com.android.mediacenter";

    private static final String camera = "am start -n com.huawei.camera/com.huawei.camera";
    private static final String stop_camera = "am force-stop com.huawei.camera";

    private static final String gallery = "am start -n com.android.gallery3d/com.huawei.gallery.app.GalleryMain";
    private static final String stop_gallery = "am force-stop com.android.gallery3d";

    private static final String Video = "am start -n com.huawei.hwvplayer.youku/com.huawei.hwvplayer.framework.MainActivity";
    private static final String stop_Video = "am force-stop com.huawei.hwvplayer.youku";

    private static final String setting = "am start -n com.android.settings/.HWSettings";
    private static final String stop_setting = "am force-stop com.android.settings";
    ...
    public void UserLocalApp() throws Exception {
        ...
        device.registerWatcher("permession", new UiWatcher() {
            ...
            public boolean checkForCondition() {
                UiObject2 OK = device.wait(Until.findObject(By.text("Allow")), 1000);
                if (OK != null) {
        ...
        while (i-- > 0) {
            ...
            UiObject2 one = device.wait(Until.findObject(By.text("1")), 1000);
            if (one != null) {
                help.Log(" click 1");
                one.clickAndWait(Until.newWindow(), 1000);
                one.clickAndWait(Until.newWindow(), 1000);
            }
            UiObject2 two = device.wait(Until.findObject(By.text("2")), 1000);
            if (two != null) {
                help.Log("click 2");
                two.click();
            }
            UiObject2 call = device.wait(Until.findObject(By.res("com.android.contacts:id/dialButton")), 1000);
            if (call != null) {
                help.Log("call");
                call.clickAndWait(Until.newWindow(), 1000);
                Thread.sleep(5000);
            }
            UiObject2 stopcall = device.wait(Until.findObject(By.res("com.android.incallui:id/endButton")), 1000);
            if (stopcall != null) {
                help.Log("stop call");
        ...
        while (i-- > 0) {
            ...
            command(music);
            Thread.sleep(5000);
            UiObject2 home = device.wait(Until.findObject(By.text("我的")), 5000);
            home.clickAndWait(Until.newWindow(), 5000);
            UiObject2 song = device.wait(Until.findObject(By.text("本地歌曲")), 5000);
            song.clickAndWait(Until.newWindow(), 1000);
            Thread.sleep(2000);
            UiObject2 satrt = device.wait(Until.findObject(By.res("com.android.mediacenter:id/listview_layout")), 1000).getChildren().get(1);
            if (satrt != null)
        ...
        while (i-- > 0) {
            ...
            Thread.sleep(5000);
            help.Log("play photo");
            UiObject2 take = device.wait(Until.findObject(By.res("com.huawei.camera:id/shutter_button")), 1000);
