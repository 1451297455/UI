...
public class LocalApp8 {

    //定义启动/停止应用的命令
    private static final String dialer = "am start -n com.android.dialer/.app.DialtactsActivity";
    ...
    private static final String setting = "am start  com.android.settings";
